...
pyANTI-FASc is able to generate work on the meshes made available by the European Databases of Seismogenic Faults Services ([EFSM20](https://seismofaults.eu/component/tags/tag/efsm20)).  Specifically the meshes generated by the EFSM20 Meshes service available whose details can be found [here](https://seismofaults.eu/services/efsm20-services): at this [link](https://services.seismofaults.eu/EFSM20_Meshes/ows?service=WFS&request=GetCapabilities) you can find the xml file to upload the provided database on QGis sofwtare. If you use this service, please refer to [https://doi.org/10.13127/efsm20/meshes](https://doi.org/10.13127/efsm20/meshes) In figure 1 you can see a screenshot showing some of the available meshed fault within the EFSM20 database
